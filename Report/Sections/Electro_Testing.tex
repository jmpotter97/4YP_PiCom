...
\todo[inline,color=blue!20]{Write Computing and Components Sections}
...
\todo[inline]{Missing reference above and -- Check rise time and max freq of this function below}
\begin{figure}[ht]
	\centering
