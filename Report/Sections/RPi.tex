...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.35\textwidth]{DAC_Layout.jpg}
	\includegraphics[width=0.6\textwidth]{ad5424.png}
...
\missingfigure{Layout of the Analogue Digital Converter}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.6\textwidth]{Pi_Pin_Connections.png}
...
\todo[inline,color=green!40]{Make sure the corresponding section does reference the fact that the DAC doesn't work exactly as it's supposed to and how I dealt with it}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.8\textwidth]{Mask_Expansion.jpg}
