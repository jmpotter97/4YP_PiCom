...
\todo[inline]{Include matplotlib if used in the end}
\lstset{style=python}
...
and \textit{GPIO.wait\textunderscore for\textunderscore edge()} on the clock pin to trigger reading of the
...
\todo[inline,color=blue!20]{Definitely have a full page flow chart for the transmitter and receiver code}
